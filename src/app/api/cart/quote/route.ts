...
export async function POST(request: Request) {
  ...
  } catch { return Response.json({ error: "Le panier contient un article indisponible, une quantité invalide ou la boutique est momentanément inaccessible. Vous pouvez retirer un article et réessayer." }, { status: 400 }); }
}
